...
//    strcat(full_name,",");              // concatenate full_name and a comma
//    strcat(full_name,last_name);        // concatenate last_name to full_name 
//    cout << "Your full name is: " << full_name << endl;
//    
//    cout << "==========================" << endl;
//    cout << "Enter your full name: ";
//    cin >> full_name;                  // only displays first name due to white space between char
//    cout << "Your full name is: " << full_name << endl;
    
    cout << "==========================" << endl;
    
    cout << "Enter your full name: ";
    cin.getline(full_name,50);       // displays first and last name with white space
    cout << "Your full name is: " << full_name << endl;
