...
int main(){
    ...
    string name {"Nathan"};
    cout << "\nnum before calling pass_by_ref2: " << name << endl;
    pass_by_ref2(name);
    cout << "nnum after calling pass_by_ref2: " << name << endl;
    
    vector<string> stooges{"Larry", "Moe", "Curly"};
    cout << "\nnum before calling pass_by_ref3: ";
    print_vector(stooges);
    pass_by_ref3(stooges);
    cout << "num after calling pass_by_ref3: ";
    print_vector(stooges);
